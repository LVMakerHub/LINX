...
#----------------------- Shared Objects -----------------------
raspberryPi2BLib:
	$(CXX) $(LDFLAGS) $(CPPFLAGS) $(CFLAGS) $(INC) -Wall -shared -fPIC -lrt -o ../core/examples/LinxDeviceLib/bin/liblinxdevice_rpi2.so ../core/examples/LinxDeviceLib/src/LinxDeviceLib.cpp $(CORE_RPI2) $(HW_RPI2B) -DLINXCONFIG -DDEBUG_ENABLED=-1

raspberryPi5Lib:
	$(CXX) $(LDFLAGS) $(CPPFLAGS) $(CFLAGS) $(INC) -Wall -shared -fPIC -lrt -o ../core/examples/LinxDeviceLib/bin/liblinxdevice_rpi5.so ../core/examples/LinxDeviceLib/src/LinxDeviceLib.cpp $(CORE_RPI5) $(HW_RPI5) -DLINXCONFIG -DDEBUG_ENABLED=-1
...
raspberryPi5Serial:
	@mkdir -p ../core/examples/RaspberryPi_5_Serial/bin
...
raspberryPi5Tcp:
	@mkdir -p ../core/examples/RaspberryPi_5_Tcp/bin
...
raspberryPi5Configurable:
	@mkdir -p ../core/examples/RaspberryPi_5_Configurable/bin
